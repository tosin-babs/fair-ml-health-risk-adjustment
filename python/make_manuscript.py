...
Produces, in manuscript/:
  Paper6_Babalola.docx  - what most journals want uploaded
  Paper6_Babalola.pdf   - for reading and for the preprint server
...
SRC = MS / "Paper6_manuscript.md"
TABLES = MS / "tables.md"
COMBINED = MS / ".combined.md"
DOCX = MS / "Paper6_Babalola.docx"
PDF = MS / "Paper6_Babalola.pdf"
HTML = MS / ".paper.html"
